...
typedef enum error_type {
    ...
    IDENTIFIER_EXPECTED_PROC_DECLARATION,
    SEMICOLON_EXPECTED_PROC_DECLARATION,
    CALL_TO_UNDECLARED_PROCEDURE,
    CALL_TO_NON_PROCEDURE,
    IDENTIFIER_EXPECTED_PROC_STATEMENT
} error_type;
